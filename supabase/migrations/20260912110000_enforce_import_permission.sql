-- Security hardening: import ingestion must honor the organization permission model.
-- Membership alone is not sufficient authorization for financial-data import.

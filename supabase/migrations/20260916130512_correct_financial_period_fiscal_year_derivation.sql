...
set fiscal_year = case
  when extract(month from fp.period_start)::integer < greatest(1, least(12, o.fiscal_year_start_month))
    then extract(year from fp.period_start)::integer - 1
  else extract(year from fp.period_start)::integer
end
from public.organizations o
where o.id = fp.organization_id;

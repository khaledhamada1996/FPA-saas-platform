-- Security hardening: publishing imported actuals is a privileged import lifecycle action.
-- Keep the function SECURITY INVOKER so all table RLS remains effective, while
-- explicitly requiring the organization-level import permission before publishing.

...
begin
  ...
  select coalesce(jsonb_agg(to_jsonb(x) order by x.created_at desc),'[]'::jsonb)
    into v_items
  from (
    select b.id,b.input_type,b.file_name,b.status,b.row_count,b.accepted_count,
           b.rejected_count,b.error_count,b.created_at,b.applied_at,b.created_by,b.applied_by

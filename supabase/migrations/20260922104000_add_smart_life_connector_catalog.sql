insert into public.connector_catalog(
 ...
 'smart_life','Smart Life','accounting','database','secret_reference',
 '{"sync":true,"incremental":true,"read_accounts":true,"read_journal_entries":true,"read_trial_balance":true}',

...
export default function InvitePage(){
  ...
  useEffect(()=>{
    ...
    async function run(){
      ...
      if(error||!data?.ok){if(active){setStatus("error");setMessage(error?.message||"رابط الدعوة منتهي أو غير صالح أو لا يطابق البريد المسجل.");}return;}

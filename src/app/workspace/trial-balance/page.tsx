...
export default function TrialBalancePage() {
  ...
  useEffect(() => {
    ...
    void supabase.rpc("get_financial_data_date_range", { p_organization_id: id }).then(({ data: result, error: e }) => {
      if (e) setError(e.message);
      else {
        const min = result?.min_date || ""; const max = result?.max_date || "";
